...
class DiaryContentTopDownDbObject {
  ...
  factory DiaryContentTopDownDbObject.fromJson(Map<String, dynamic> json) =>
      _$DiaryContentTopDownDbObjectFromJson(json);
  Map<String, dynamic> toJson() => _$DiaryContentTopDownDbObjectToJson(this);
}
